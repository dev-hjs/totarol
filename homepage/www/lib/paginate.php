...
if($total_row>0)
{
	...
	{
		$page = $page_now - 1;
		echo "<a href=\"javascript:goList('{$page}')\" class=\"direction prev\"><img src='/image/btn_page_prev.png' width=12 height=18 align=absmiddle></a>";
	} else {
		echo "<a href=\"javascript:goList('0')\" class=\"direction prev\"><img src='/image/btn_page_prev.png' width=12 height=18 align=absmiddle></a>";
	}
	// 페이지 바로가기 링크
	...
	{
		$page = $page_now + 1;
	 	echo "<a href=\"javascript:goList('{$page}')\" class=\"direction prev\"><img src='/image/btn_page_next.png' width=12 height=18 align=absmiddle></a>";
...
else
{
    ...
    echo "<strong>1</strong>";
 	echo "<a href=\"javascript:goList('0')\" class=\"direction prev\"><img src='/image/btn_page_next.png' width=12 height=18 align=absmiddle></a>";
